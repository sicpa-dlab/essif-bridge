    ...
    return (
      <div className="verify-crendential bx--col-lg-7 bx--col-md-5  bx--col-sm-3">
        ...
        <div className="verify-crendential-tile" >
          <Tile header="Paris Regional Medical Centre" content="Verify your digital EHIC to receive treatment at the right coast." logo={ehicVerifier} url="https://verifier.essif.adaptivespace.io" />
        </div>
      </div>
    )
  }
