        ...
        <div className="home">
          <div className="home-content">
            ...
            <div className="bx--col-lg-6 bx--no-gutter" style={{ display: 'flex', flexFlow: 'row wrap' }}>
              <Tile header="Issuer" content="Ministry of Social Security & Inclusion." logo={issuerLogo} url="https://issuer.essif.adaptivespace.io/issuer" />
              <Tile header="Verifier" content="Paris Regional Medical Centre." logo={verifierLogo} url="https://verifier.essif.adaptivespace.io/verifier" />
